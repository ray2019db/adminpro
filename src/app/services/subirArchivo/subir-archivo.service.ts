...
export class SubirArchivoService {
  ...
  subirArchivo(archivo: File, tipo: string, id: string){
    ...
    return new Promise( (resolve, reject) => {  // Declaración de una promesa
      ...
      formData.append('imagen', archivo, archivo.name);// Configuración del formData 'imagen' es el nombre que se pone al key de postman para enviar el archivo por el req.body.imagen, archivo es el archivo completo a subir y archivo.name es el nombre del archivo
